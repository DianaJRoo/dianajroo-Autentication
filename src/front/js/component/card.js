...
const Card = (props) => {
    return (
        ...
        <div className="flex-grow flex flex-col bg-neutral-100 border border-gray-200 rounded-lg overflow-hidden mt-3 mb-3 transform hover:scale-110 transition-transform duration-300 ease-in-out hover:shadow-xl" style={{ width: '15rem',   }}>
