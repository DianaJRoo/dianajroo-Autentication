...
const CardSong = (props) => {
    return (
        ...
        <div id='hero' className="max-w-sm rounded-lg overflow-hidden shadow-lg flex justify-around hover:scale-110 transition-transform duration-300 ease-in-out bg-white" >
